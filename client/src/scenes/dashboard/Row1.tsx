   ...
   const revenue = useMemo(() => {
    ...
    return (
        ...
        >
          ...
          />
          <Tooltip />
          <Area type="monotone" dataKey="revenue" dot={true} 
                stroke={palette.primary.main} fillOpacity={1} fill="url(#colorRevenue)" />
          <Area type="monotone" dataKey="expenses" dot={true} 
                stroke={palette.primary.main} fillOpacity={1} fill="url(#colorExpenses)" />
        </AreaChart>
      </ResponsiveContainer>
        </DashboardBox>
        ...
        >
          ...
          <Line yAxisId="right" type="monotone" dataKey="revenue" dot={true} 
                stroke={palette.primary.main} fillOpacity={1} fill="url(#colorRevenue)" />
          <Line yAxisId="left" type="monotone" dataKey="profit" dot={true} 
                stroke={palette.tertiary[500]} fillOpacity={1} fill="url(#colorExpenses)" />
        </LineChart>
      </ResponsiveContainer>
        </DashboardBox>
